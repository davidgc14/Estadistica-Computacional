...
r.estandarizados <- rstandard(mod1)
plot(mod1$fitted.values, r.estandarizados) # Valores ajustados respecto de los residuos
plot(xij, r.estandarizados) 
...
# Incorrelación
plot(hatco$empresa, r.estandarizados)
library(lmtest)
dwtest(mod1)
...
# Normalidad
ks.test(r.estandarizados, pnorm)
qqnorm(r.estandarizados)
qqline(r.estandarizados)
